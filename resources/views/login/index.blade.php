        ...
        <div class="container">
            <div class="wrapper">
                ...
                <form id="formCadastro" name="formulario" action="{{route('login')}}" method="POST">
                    ...
                    <div class="input-box">
                        <input id="txtSenha" name="txtSenha" type="password" placeholder="Crie uma senha" minlength="5" required> <!-- minlength e maxlenght são usadas para limitar caracteres em um campo input-->
                    </div>
                    <div class="input-box">
                        <input id="repetir_senha" name="repetir_senha" type="password" placeholder="Repita a senha" required>
                    </div>
                    <div class="policy">
